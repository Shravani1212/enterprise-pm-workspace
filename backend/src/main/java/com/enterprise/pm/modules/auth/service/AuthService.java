...
import com.enterprise.pm.modules.auth.repository.RefreshTokenRepository;
import com.enterprise.pm.modules.auth.repository.RoleRepository;
import com.enterprise.pm.modules.auth.repository.SessionRepository;
import com.enterprise.pm.modules.auth.repository.UserRepository;
import com.enterprise.pm.security.JwtTokenProvider;
...
public class AuthService {
    ...
    public UserResponse register(RegisterRequest request) {
        ...
        Role defaultRole = roleRepository.findByCode("DEVELOPER")
                .orElseThrow(() -> new ResourceNotFoundException("Default DEVELOPER role not found"));
