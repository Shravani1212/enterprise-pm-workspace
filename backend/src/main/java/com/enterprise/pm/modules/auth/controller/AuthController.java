...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> refreshToken(
            ...
            @RequestParam(name = "token", required = false) String queryRefreshToken) {

        String tokenToUse = cookieRefreshToken != null ? cookieRefreshToken : queryRefreshToken;
        if (tokenToUse == null) {
            throw new IllegalArgumentException("Refresh token cookie or parameter is required");
        }
    ...
    public ResponseEntity<ApiResponse<Void>> revokeSession(@AuthenticationPrincipal UserPrincipal currentUser,
