package com.projectpulse.pm.modules.metadata.service;
...
public class MetadataService {
    ...
    public List<TaskStatusResponse> getStatusesForProject(Long projectId) {
        List<com.projectpulse.pm.modules.metadata.entity.TaskStatus> statuses = taskStatusRepository.findActiveByProjectIdOrGlobal(projectId);
